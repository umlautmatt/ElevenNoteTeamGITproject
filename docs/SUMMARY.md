...
* ElevenNote (Parts 1-11)
    ...
    * Part 3: Database Setup
        ...
        * [3.1: Annotations](3-DatabaseSetup/3.1-Annotations.md)
        * [3.2: Migrations](3-DatabaseSetup/3.2-Migrations.md)
        * [3.3: GUID Info](3-DatabaseSetup/3.3-GUIDInfo.md)            
        * [3.4: Types](3-DatabaseSetup/3.4-Types.md)
        * [3.5: Password Information](2-IdentityModel/3.5-PasswordInformation.md)
        * [3.6: Database and Connection String](3-DatabaseSetup/3.6-DatabaseAndConnectionString.md)
    * Part 4: NoteListItem
